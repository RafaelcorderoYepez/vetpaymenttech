...
export function BrandLockup({ variant = "default" }: { variant?: "default" | "light" }) {
  return (
    <div className="flex min-w-0 items-center">
      <img
        ...
        width={1200}
        height={328}
        className={`h-9 w-auto max-w-[180px] object-contain sm:h-11 lg:h-20 lg:max-w-[320px] ${variant === "light" ? "brightness-0 invert" : ""}`}
      />
    </div>
  );
}
    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-9 lg:grid-cols-[1.3fr_.7fr_.7fr]">
          <div><BrandLockup variant="light" /><p className="mt-5 max-w-md leading-relaxed text-primary-foreground/75">Complete payment solutions for modern veterinary practices, backed by personal local support.</p><p className="mt-5 font-script text-3xl text-accent">Partners in a Healthier Tomorrow</p></div>
